...
it('reports the average as NaN because of large standard deviation', ()=> {
  expect(average([1, 2, 4, 5, 3, 3, 6, 2, 1000])).to.be.NaN;
});

it('ignore NaN', ()=> {
  expect(average([1, NaN, 2, 7, NaN])).to.be.approximately(3.33, 0.01);
});
